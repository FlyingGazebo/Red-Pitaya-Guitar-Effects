...
############################################################################
##  File name :       /home/eva/RedPitaya/FPGA/release1/fpga/ahead/red_pitaya.srcs/sources_1/edk/system/implementation/processing_system7_0_wrapper/processing_system7_0.xdc
##
...
# Clock constraints                                                        #
############################################################################
create_clock -name clk_fpga_1 -period "4" [get_nets "FCLK_CLK1"]
set_input_jitter clk_fpga_1 0.12
create_clock -name clk_fpga_2 -period "20" [get_nets "FCLK_CLK2"]
set_input_jitter clk_fpga_2 0.6
create_clock -name clk_fpga_0 -period "8" [get_nets "FCLK_CLK0"]
set_input_jitter clk_fpga_0 0.24
create_clock -name clk_fpga_3 -period "5" [get_nets "FCLK_CLK3"]
