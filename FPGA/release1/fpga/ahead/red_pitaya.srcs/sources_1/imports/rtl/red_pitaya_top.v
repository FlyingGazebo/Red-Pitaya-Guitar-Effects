...
// choose the signal to move to DAC 
...
begin
        if (|guitar_dac)
        begin
        //overflow already handled in the amp module
...
//        if (guitar_dac[15] == 1'b1)
//        begin
//            if (guitar_dac[14:13] == 1'b11) // no overflow
//                dac_a <= {1'b1, ~guitar_dac[12:0]};
//            else
//                dac_a <= 14'h2000 ;
//        end
//        else if (guitar_dac[15] == 1'b0)
//        begin
//            if (guitar_dac[14:13] == 1'b00) // no overflow
//                dac_a <= {1'b0, ~guitar_dac[12:0]};
//            else
//                dac_a <= 14'h1FFF ;
//        end
...
//        begin
//            if (guitar_dac[14:13] == 1'b00) // no overflow
//                dac_b <= {1'b0, ~guitar_dac[12:0]};
//            else
//                dac_b <= 14'h1FFF ;            
//        end
    
    else // there are currently only two modules that use dac
    begin
